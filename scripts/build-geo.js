...
let url = `https://vercel-pro.190699.xyz/proxy/raw.githubusercontent.com/GitSquared/node-geolite2-redist/master/redist/${db}.tar.gz`;

if (process.env.MAXMIND_LICENSE_KEY) {
  url =
    `https://vercel-pro.190699.xyz/proxy/download.maxmind.com/app/geoip_download` +
